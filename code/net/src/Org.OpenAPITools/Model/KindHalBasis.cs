...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class KindHalBasis :  IEquatable<KindHalBasis>, IValidatableObject
    {
        ...
        public KindHalBasis(string burgerservicenummer = default(string), KindInOnderzoek inOnderzoek = default(KindInOnderzoek), Naam naam = default(Naam), Geboorte geboorte = default(Geboorte), bool geheimhoudingPersoonsgegevens = default(bool), KindLinks links = default(KindLinks))
        {
