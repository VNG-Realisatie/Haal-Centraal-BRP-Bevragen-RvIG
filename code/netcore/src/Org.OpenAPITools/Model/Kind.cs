...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Kind : IEquatable<Kind>, IValidatableObject
    {
        ...
        public Kind(string burgerservicenummer = default(string), KindInOnderzoek inOnderzoek = default(KindInOnderzoek), Naam naam = default(Naam), Geboorte geboorte = default(Geboorte), bool geheimhoudingPersoonsgegevens = default(bool))
        {
