...
public class IngeschrevenPersoonHalBasis {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(burgerservicenummer, geheimhoudingPersoonsgegevens, geslachtsaanduiding, datumEersteInschrijvingGBA, kiesrecht, naam, inOnderzoek, nationaliteiten, geboorte, opschortingBijhouding, overlijden, verblijfplaats, gezagsverhouding, verblijfstitel, reisdocumentnummers, links);
  }
